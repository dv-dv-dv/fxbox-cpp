...
private:
	...
	const pflt very_small = 0.9 / pow(2, 15);
	...
	a2d::Array2D<pflt>& linear_to_db(a2d::Array2D<pflt>& audio_level);
	a2d::Array2D<pflt>& db_to_linear(a2d::Array2D<pflt>& audio_level);
